...
echo -e "There is no separate web app for this engine any more — its UI is the studio's"
echo -e "Clip a video panel. To start that server:"
echo -e "👉 ${YELLOW}./venv/bin/python3 -m ai_studio${NC}\n"
echo -e "Navigate to ${GREEN}http://localhost:8000${NC}, press ⌘C, and drop a video in."
echo -e "(Headless still works: ${YELLOW}./run.bat videos out${NC})"
