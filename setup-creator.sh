...
echo -e "${GREEN}======================================================${NC}\n"
echo -e "Start the studio (the only web app in this repo):"
echo -e "👉 ${YELLOW}./venv/bin/python -m ai_studio${NC}"
echo -e "Open ${GREEN}http://localhost:8000${NC} — Characters and AI Team are sections in its left rail."
echo -e "\nLong-video clipping is a panel of the same studio (Clip a video, ⌘C);"
echo -e "headlessly it is still ${YELLOW}./run.bat videos out${NC}\n"
